    ...
    <section className="relative overflow-hidden bg-white pt-12 pb-20 dark:bg-slate-950 md:pt-16 md:pb-28">
      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="pt-6 border-t border-slate-100 dark:border-slate-800 space-y-4">
              ...
              <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-1">
                <div className="flex flex-col items-center gap-1.5">
                  <div className="relative h-12 w-28 rounded-xl bg-white p-2 shadow-md border border-slate-200/80 dark:bg-white/95 dark:border-slate-700 transition-all hover:scale-105">
                    <Image src="/assets/img/associations/iso.png" alt="ISO 9001 & 27001 Certified" fill className="object-contain" />
                  </div>
                  <span className="text-[11px] font-semibold text-slate-600 dark:text-slate-300 text-center max-w-[120px] leading-tight">
          ...
          {/* Right Column: Interactive 3D Interactive Phone & Multi-Channel Simulator */}
